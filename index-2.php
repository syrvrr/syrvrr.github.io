...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="assets/jadiico.ico">
  ...
  <div class="vg-main-wrapper">
    <div class="vg-page page-home" id="home" style="background-image: url(assets/img/bg_image_2.jpg);">
      <div class="caption wow zoomInUp">
        <h1 class="fw-normal">Selamat Datang!</h1>
        <h2 class="fw-medium fg-theme">Hai, Aku/Saya Andi Prayogi</h2>
        <p class="tagline">Software Engineer & Computer Science</p>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="caption wow fadeInRight">
              <h2 class="fg-dark">Andi Prayogi</h2>
              <p class="fg-theme fw-medium">Software Engineer & Computer Science</p>
              <p>Sangat cerdas kuat daya ingatannya bijaksana konsekuen dalam tindakan tabah menghadapi penderitaan agak
                pemboros percaya diri dalam segala-galanya rejekinya baik. Senang menuntut ilmu apa saja dan rajin
                belajar. Dicintai oleh banyak orang walaupun memiliki sifat keras hati. Sopan dalam bicaranya dan senang
                dijunjung. Banyak memiliki teman karena senang bergaul. - Kata Weton</p>
              <ul class="theme-list">
              ...
              <button class="btn btn-theme btn-rounded"><a href="https://www.linkedin.com/in/andi-prayogi-2a8a11157/"
                  target="_blank" class="text-reset"> Lihat CV </a></button>
            </div>
          </div>
        </div>
      </div> <!-- End profile -->
    ...
    <!-- <div class="vg-page p-0" id="testimonial">
      <div class="owl-carousel testi-carousel" style="background-image: url(assets/img/photo-2.jpg);">
        <div class="item">
          <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Minus, dicta atque. Voluptas illum quasi
            asperiores autem unde cupiditate temporibus quisquam iste rem dignissimos. Commodi placeat, quis omnis
            inventore asperiores sit.</p>
          <span class="iconic">
